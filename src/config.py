...
class Settings:
    ...
    MODEL_NAME: str = os.getenv("MODEL_NAME", "llama-3.2-3b")
    MODEL_FILE: str = os.getenv("MODEL_FILE", "Llama-3.2-3B-Instruct-Q4_K_M.gguf")
    MODEL_PATH: str = os.getenv(
        "MODEL_PATH",
        str(Path(__file__).resolve().parent.parent / "models" / os.getenv("MODEL_FILE", "Llama-3.2-3B-Instruct-Q4_K_M.gguf")),
    )
    MODEL_URL: str = os.getenv("MODEL_URL", "https://huggingface.co/bartowski/Llama-3.2-3B-Instruct-GGUF/resolve/main/Llama-3.2-3B-Instruct-Q4_K_M.gguf")
